...
function pontos_load()
	...
	tempot = (math.floor(tempo/3600)..':'..math.floor(tempo/60)..':'..math.floor(tempo%60))
...
function pontos_update(dt)
	...
	function love.mousepressed( x, y, botao )
		if botao==1 and estadojogo == 'pontos' then
...
function pontos_draw()
	...
	love.graphics.print('TEMPO TOTAL:',186,250)
	love.graphics.print(tempot,468,250)
